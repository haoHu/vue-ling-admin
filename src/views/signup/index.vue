<template>
  <div class="signup-container">
    <el-form autoComplete="off" :model="formModel" :rules="formRules" ref="formModel" label-width="0px" class="card-box login-form">
      ...
      <el-form-item prop="password">
        ...
        <el-input name="password" :type="pwdType" v-model="formModel.password" placeholder="密码"></el-input>
      ...
      <el-form-item prop="password_confirm">
        ...
        <el-input name="password_confirm" :type="pwdType" v-model="formModel.password_confirm" placeholder="确认密码"></el-input>
        <span class="svg-container show-pwd" @click='showPwd'>
          <icon-svg :icon-class="showPwdIcon()" />
        </span>
      </el-form-item>
...
import { sendCaptchaEmail } from '@/api/login';
    ...
    handleSignup() {
      this.$refs.formModel.validate(valid => {
        if (valid) {
          ...
          signup(this.formModel).then(response => {
            const code = response.data.errno.toString();
            const msg = response.data.errmsg;
            this.loading = false;
            this.$message({
